...
class ThemeStudioWebview {
    ...
    _liveColorApplyQueue = Promise.resolve();
    _liveTokenApplyQueue = Promise.resolve();
    ...
    _syncActiveThemeToWebview() {
        if (!this._panel || !this._panel.webview)
            return;
        const effective = themeEngine_1.ThemeEngine.getEffectiveThemeState();
        this._panel.webview.postMessage({
