...
export const SYNTAX_SCOPE_MAP: Readonly<Record<string, readonly string[]>> = Object.freeze(
  Object.fromEntries(SYNTAX_SCOPE_DEFINITIONS.map((definition) => [definition.id, definition.scopes]))
);
...
const WHITE_TUXEDO_SYNTAX: Record<string, string> = {
  keywords: '#ffffff',
  functions: '#e6e6e6',
  strings: '#bfbfbf',
  variables: '#f5f5f5',
...
const WHITE_TUXEDO_PRESET: ThemePreset = {
  id: 'white-tuxedo',
  name: '🤵 White Tuxedo',
  ...
  tokenColors: SYNTAX_SCOPE_DEFINITIONS.map((definition) => ({
...
const SKELETON_VALLEY_PRESET: ThemePreset = {
  id: 'skeleton-valley',
